	...
	return (
		<StyledFooter className="footer">
			<div className="container">
				<div className="footer__section footer__section--aboutUs">
					<h3>O nama</h3>
					<p>
				...
				<div className="footer__section footer__section--links">
					...
					<div className="links__items">
						{navLinks.map((navItem, index) => {
							return (
								<a key={index} href={navItem.path} title={navItem.title} className="links__item">
									{navItem.name}
								</a>
							);
						})}
				...
				<div className="footer__section footer__section--socialMedia">
